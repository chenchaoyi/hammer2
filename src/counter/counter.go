...
func (c *Counter) GetAllStat() (totalReq, totalErr, totalReqSlow, sps, rps, avg int64) {
	return c.totalReq, c.totalErr, c.totalResSlow, c.sps, c.rps, c.totalResTime / (c.totalReq * 1.0e3)
}
